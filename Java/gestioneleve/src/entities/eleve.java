...
public class eleve {
    ...
    public eleve(int id, String nom, String prenom, String niveau, int age, String adresse, int nbre_absence, int user_id, String date_naissance, int classe_id, String nom_image) {
        this.id = id;
        this.nom = nom;
        this.prenom = prenom;
        this.niveau = niveau;
